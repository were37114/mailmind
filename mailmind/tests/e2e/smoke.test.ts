...
const mockEmails: Email[] = [
  { id: 1, message_id: 'm1', thread_id: null, account_id: 'a1', from_name: '财务部', from_email: 'finance@co.com', to_list: [], cc_list: [], subject: '【审批】Q1预算', body_text: '请审批Q1预算50万，截止1月20日', date: new Date(), has_attachment: false, category: 0, urgency: 2, confidence: 0.95, created_at: new Date() },
  { id: 2, message_id: 'm2', thread_id: null, account_id: 'a1', from_name: 'PM', from_email: 'pm@co.com', to_list: [], cc_list: [], subject: '项目进度', body_text: '本周项目进度正常，待确认', date: new Date(), has_attachment: false, category: 2, urgency: 1, confidence: 0.85, created_at: new Date() },
  { id: 3, message_id: 'm3', thread_id: null, account_id: 'a1', from_name: '销售', from_email: 'sales@co.com', to_list: [], cc_list: [], subject: '月度汇报', body_text: '本月销售完成情况', date: new Date(), has_attachment: false, category: 3, urgency: 0, confidence: 0.87, created_at: new Date() },
];
